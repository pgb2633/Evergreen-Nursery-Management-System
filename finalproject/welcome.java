...
public welcome()
{
  ...
  setTitle(" EVERGREEN HOTHOUSE NURSURY ");
     ...
     l1=new JLabel("WELCOME TO EVERGREEN HOTHOUSE NURSURY ");
     l1.setFont(new Font("Courier",Font.BOLD|Font.ITALIC,35));
     l1.setBounds(100,120,800,45);
	l1.setBackground(new Color(254,224,204));
     add(l1);

	part=new JLabel("The Best Place For Beautiful Plants N Flowers");
	part.setFont(new Font("Courier",Font.BOLD,22));  
	part.setBounds(180,180,600,150);
	part.setBackground(new Color(204,204,204)); 
	add(part);

  name1=new JLabel("WE HELP U 2 ADD COLORS 2 UR LIFE");
  name1.setFont(new Font("Courier",Font.BOLD,25));
  name1.setBounds(180,240,500,150);
