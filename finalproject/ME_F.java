...
class ME_F extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		c9=DriverManager.getConnection("jdbc:postgresql://localhost/agri","postgres","1234");
		...
		{  
           ...
           {
          Class.forName("org.postgresql.Driver");
		c999=DriverManager.getConnection("jdbc:postgresql://localhost/agri","postgres","1234");
			...
			if(source==ac)
		{
			 ...
			 {
			Class.forName("org.postgresql.Driver");
		c99=DriverManager.getConnection("jdbc:postgresql://localhost/agri","postgres","password");
