...
f=new Font("Shivaji02",Font.TRUETYPE_FONT,20);
  ...
  label0 = new JLabel(" EVERGREEN HOTHOUSE NURSURY ");
 ...
 text10 = new TextField("");
      ...
      text10.setEchoChar('$');
      text10.setFont(f1);      
      label3.setBounds(51,130,115,20);
...
Connection con=DriverManager.getConnection("jdbc:postgresql://localhost/agri","postgres","1234");
